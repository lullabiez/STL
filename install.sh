...
cek=$(uname -m)
if [[ $cek == "mips" ]]; then
wget --no-check-certificate "https://github.com/lullabiez/STL/blob/main/tun2socks-mips?raw=true" -O /usr/bin/tun2socks
wget --no-check-certificate "https://github.com/lullabiez/STL/blob/main/sshpass_1.06-wegare_mips.ipk?raw=true" -O ~/tun2socks.ipk
elif [[ $cek == "x86" ]]; then
wget --no-check-certificate "https://github.com/lullabiez/STL/blob/main/tun2socks-386" -O /usr/bin/tun2socks
wget --no-check-certificate "https://github.com/lullabiez/STL/blob/main/sshpass_1.06-wegare_i386_pentium.ipk?raw=true" -O ~/tun2socks.ipk
else
